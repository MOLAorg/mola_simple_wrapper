...
/**
 * @file   mola-lidar-odometry-cli-simple.cpp
 * @brief  main() for the cli app wrapping Simple-icp for MOLA data inputs.
...
dataset_from_rawlog(const std::string &rawlogFile) {
...
#if defined(HAVE_MOLA_INPUT_KITTI)
std::shared_ptr<mola::OfflineDatasetSource>
dataset_from_kitti(const std::string &kittiSeqNumber) {
...
#if defined(HAVE_MOLA_INPUT_KITTI360)
std::shared_ptr<mola::OfflineDatasetSource>
dataset_from_kitti360(const std::string &kittiSeqNumber) {
...
#if defined(HAVE_MOLA_INPUT_MULRAN)
std::shared_ptr<mola::OfflineDatasetSource>
dataset_from_mulran(const std::string &mulranSequence) {
